...
ProductRoute.get("/1c/clear/:version", AuthMiddleware, ProductController.getClearAll);
ProductRoute.get("/1c/:uuid_1c", AuthMiddleware, ProductController.getUuid);
ProductRoute.get("/1c/deleted/:status/:version", AuthMiddleware, ProductController.getAllDeleted);
